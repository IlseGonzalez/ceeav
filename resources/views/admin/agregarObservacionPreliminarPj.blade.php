 ...
 <div class="card text-white" style="background-color: rgb(139, 0, 69)">
    <center>
        <h6>VI. OBSERVACIONES PRELIMINARES DE LOS JUZGADOS</h6>
    </center>
</div>
<form id="autPj" name="autPj" action="{{ route('guardar_observacion_preliminar_pj') }}" method="post">
    @csrf
    <input type="hidden" id="id_pj" name="id_pj" value="{{ $id_pj }}">
